...
return {
	...
	keys = {
		-- { '[Space]<tab>', '<Cmd>Neotree source=last reveal=true position=float<CR>',                  'n', silent = true },
		{ "[Space]v", "<Cmd>Neotree source=filesystem reveal=true position=left toggle=true<CR>", "n", silent = true },
	},
	config = function()
